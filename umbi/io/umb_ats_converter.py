...
def explicit_umb_to_explicit_ats(umb: ExplicitUmb) -> umbi.ats.ExplicitAts:
    raise NotImplementedError("explicit_umb_to_explicit_ats is not yet implemented")
    # umb.validate()
...
def explicit_ats_to_explicit_umb(ats: umbi.ats.ExplicitAts) -> ExplicitUmb:
    raise NotImplementedError("explicit_ats_to_explicit_umb is not yet implemented")
    # ats.validate()
    # umb = ExplicitUmb()
